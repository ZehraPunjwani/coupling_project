...
import zehrakent.looselycoupled.Evidence;
...
public class EvidenceBox {
	...
	private static ArrayList<Evidence> evidence;
	 ...
	 * @return
	 */
	public static List<Evidence> getEvidenceByType(String type){ //getEvidence() method with parameter type (data type String) and caseNumber (Data type Integer) - method return type List<Evidence>
		...
		for (Evidence item : evidence){ // extract the item (data type Evidence - cross refernce Evidence Class) in evidenceBox 
		...
		return desiredEvidenceType; //return desiredEvidenceType - return type List<Evidence>
	}
	
	/**
	 * 
	 * add type to the evidence ArrayList
	 * 
	 * @param type
	 */
